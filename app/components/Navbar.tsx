...
import { FaFacebook, FaInstagram, FaLinkedin, FaTwitter } from 'react-icons/fa'; // Importing the social media icons
    ...
    return (
        <>
            <header className="hidden lg:flex h-[54px] bg-[#F7F7F7] pl-[64px] pr-[62px] items-center border-b border-[#000000]">
                <div className="h-[30px] w-full text-[14px] text-[#000000] flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <span>Phone Number: 03427359563</span>
                        <span className="border border-[#676767] h-4"></span>
                        <span>Email: info@ddsgnr.com</span>
                    </div>
                    <div className="flex items-center gap-4">
                        {/* Adding social media icons here with black color */}
            ...
            <nav className="h-[72px] bg-[#F7F7F7] px-[20px] lg:px-[64px] border-b border-[#000000] flex items-center justify-between">
                <Image
                    src="/logo.jpeg" // Corrected path to logo in the public folder
                    alt="Logo"
                    width={130.6}
                    height={30.38}
                />
            ...
            <div
                className={`fixed top-0 left-0 h-full w-[250px] bg-[#F7F7F7] shadow-lg transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} transition-transform lg:hidden`}
            >
