            ...
            <div className="flex flex-wrap justify-center gap-6 md:gap-8 mt-12 md:mt-16">
                {[1, 2, 3, 4, 5, 6].map((item) => (
                    ...
                    >
                        ...
                        <Image
                            src={`/img${item}.jpeg`}  // Images are directly in the public folder
                            alt={`image-${item}`}      // Corrected alt text
                            height={300}
                            width={416}
                        ...
                        <div className="flex items-center mt-6 justify-between">
                            ...
                            <div className="flex items-center mr-2">
                                <Image
                                    src={"/rating.png"}  // Assuming the rating image is in the public folder too
                                    alt="rating"
                                    width={20}
                                    height={20}
                                />
